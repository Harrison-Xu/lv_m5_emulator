...
static lv_obj_t * right_cont_create(lv_obj_t * parent)
{
    ...
    dropdown_create(right_cont, "Language", "English\n简体中文\nعربي", &ebike_subject_language);
    switch_create(right_cont, "Bluetooth", NULL);
    switch_create(right_cont, "Lights", NULL);
    slider_create(right_cont, "Brightness");
    slider_create(right_cont, "Volume");
    slider_create(right_cont, "Max. speed");
    slider_create(right_cont, "Light level");
